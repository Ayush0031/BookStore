...
function Navbar() {
    ...
    return (
        <>
            <div className={`max-w-screen-2xl  dark:bg-slate-900 dark:text-white container mx-auto md:px-20 px-4 z-50 fixed top-0 right-0 left-0
            ${sticky ? "sticky-navbar transition-all dark:bg-slate-600 dark:text-white duration-300 ease-in-out bg-base-200 shadow-md" : ""}
            `}>
                <div className="navbar ">
                    ...
                    <div className="navbar-end space-x-3">
                        ...
                        <div className='hidden sm:block'>
                            <label className="px-2 py-1 border rounded-2xl flex items-center gap-2">
